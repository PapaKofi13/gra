    ...
    <div class="ts-main-content">
        <nav class="ts-sidebar">
            <ul class="ts-sidebar-menu">
                ...
                <li><a href="equipment_allocation.html"><i class="fa fa-pie-chart"></i> Equpment Allocation </a></li>
                <li><a href="reassignment_form.html"><i class="fa fa-table"></i> Reassignment Form </a></li>
                <li><a href="equipment_return.html"><i class="fa fa-edit"></i> Equpment Retun Form</a></li>
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM it_equipment_allocation_form
