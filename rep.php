    ...
    <div class="ts-main-content">
        <nav class="ts-sidebar">
            <ul class="ts-sidebar-menu">
                ...
                <li><a href="repairs.php"><i class="fa fa-pie-chart"></i> Repairs and Maintenance </a></li>
...
if (isset($_SESSION['logged_in'])){
    ...
    $hole_error = "";
    $name = $_SESSION['Name'];
    echo " Hello  ".$name." Welcome !!  Below are the list of repairs and maitenance goods .";

     $con=mysqli_connect ('localhost','root','','gra');
     $results=mysqli_query($con,"select * from repairs_maintenance_request_form");
     echo "<table id='zctb' class='display table table-striped table-bordered table-hover' cellspacing='0' width='100%' >
        <tr>
            ...
            <th>Date_Item_Recieved</th>
            <th>Job_undertaken_By</th>
            <th>Worker_rank</th>
            <th>Nature_Of_Problem</th>
            <th>Action_Taken</th>
            <th>Remarks</th>
...
while ($row=mysqli_fetch_array($results))
{
    ...
    echo "<td>".$row['Date_Item_Recieved']."</td>";
    echo "<td>".$row['Job_undertaken_By']."</td>";
    echo "<td>".$row['Worker_rank']."</td>";
    echo "<td>".$row['Nature_Of_Problem']."</td>";
    echo "<td>".$row['Action_Taken']."</td>";
    echo "<td>".$row['Remarks']."</td>";
    echo "<td>".$row['Supervisor_name']."</td>";
    echo "<td>".$row['Supervisor_Rank']."</td>";
