...
if (isset($_SESSION['logged_in'])){
    ...
    $hole_error = "";
    $name = $_SESSION['Name'];
    echo " Hello  ".$name." Welcome !!  Below are the list of allocated equipments. You can select an option from the left navigation column to add add items to the database";
