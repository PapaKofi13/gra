<?php
	...
	if(isset($_GET['equipment'])){
		...
		$query = "SELECT * FROM it_return_form WHERE `id`=".$equipment." LIMIT 1";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"> IT Equipment Return Form</h2>
								<form action="sreturn.php" method="GET">
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form action="rtrn.php" method="POST" name="gra">
											<fieldset>
